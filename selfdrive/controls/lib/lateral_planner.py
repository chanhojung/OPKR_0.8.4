...
class LateralPlanner():
  ...
  def update(self, sm, CP):
    ...
    self.steer_rate_cost = interp(v_ego, [0.0, 8.0, 15.0], [1.0, 0.5, CP.steerRateCost])
    ...
    if self.use_lanelines:
      ...
      heading_cost = interp(v_ego, [0.0, 8.0, 15.0], [MPC_COST_LAT.HEADING*2., MPC_COST_LAT.HEADING, 0.0])
